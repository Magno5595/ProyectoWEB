...
<html>
    ...
    <body>
        <table>
            <tr>
                <th>MENU</th>
                <th><a href="http://localhost:8003/WADPROYECTO/CrearExamenP1.jsp">Crear Examen de lectura</a></th>
        ...
        <s:iterator value="lista2">
            ...
            <s:url action="borrarexamen.action" var="url2">
            <s:param name="id">
                <s:property value="idexamen" />
            </s:param>
            </s:url>
            
            <s:url action="VerPreguntasExamen.action" var="url3">
            <s:param name="id">
                <s:property value="idexamen" />
            </s:param>
            </s:url>
